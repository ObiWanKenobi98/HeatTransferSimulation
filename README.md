 ...
 using the Finite Difference Method for the Heat Transer equation. The simulation parameters can be adjusted to see
...
thermal equilibrium.
 ...
 heat source ($T_S$) is introduced at a specific coordinate $(x_0, y_0)$. The propagation of heat is calculated iteratively using
 a 3x3 mean filter, where the temperature of a point at time $t+1$ is the average of itself and its eight immediate neighbors at time
 $t$:$$P[x,y](t+1) = \frac{1}{9} \sum_{i=-1}^{1} \sum_{j=-1}^{1} P[x+j, y+i](t)$$
 ...
 # Usage
 To compile the program, import the project in your C++ development enironment (Visual Studio) and build the solution.
 ...
 <img src="images/HeatTransferSimulationDemo.jpeg" alt="Heat Transfer Simulation Demo">
